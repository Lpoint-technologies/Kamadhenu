...
def save_fence():
    try:
        ...
        # ========== REMOVED GPS TRACKING START ==========
        # GPS tracking is now handled by ESP32 sending data directly to server
        # No need to start background thread anymore
        ...
        return jsonify({
            "status": "success", 
            "message": f"Geofence saved for Cow {cow_id}. ESP32 will handle GPS tracking."
        })
